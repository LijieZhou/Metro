...
def main():
    ...
    for row in rows:
        ...
        same_course_number_as_prev = row[COURSE_NUMBER] == prev_row[COURSE_NUMBER]
        duplicate_of_prev = same_id_as_prev and same_subject_as_prev and same_course_number_as_prev
